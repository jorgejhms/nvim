...
-- Movimiento de cursor entre palabras con <alt>
map('', '<A-h>', 'b', {noremap = true, silent = true} )
map('', '<A-l>', 'w', {noremap = true, silent = true} )
...
map("n", "<leader>ui", ":IndentBlanklineToggle!<cr>", {noremap = true, silent=true, desc = "Alterna guias de indentación"})
