...
map("n", "<leader>ds", "<cmd>Pick lsp scope='document_symbol'<CR>", { desc = "Ver simbolos del documento" })
map("n", "gD", "<cmd>Pick lsp scope='declaration'<CR>", { desc = "Ir a la declaración" })
map("n", "gd", "<cmd>Pick lsp scope='definition'<CR>", { desc = "Ir a la definición" })
map("n", "gr", "<cmd>Pick lsp scope='references'<CR>", { desc = "Ir a las referencias" })
map("n", "gI", "<cmd>Pick lsp scope='implementation'<CR>", { desc = "Ir a la implementación" })
map("n", "<leader>D", "<cmd>Pick lsp scope='type_definition'<CR>", { desc = "Ir a la definición de tipo" })
map("n", "<leader>ws", "<cmd>Pick lsp scope='workspace_symbol'<CR>", { desc = "Ir a la definición de tipo" })
